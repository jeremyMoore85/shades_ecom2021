<?php 
/**
 * Template Name: Loungewear Landing Page Template
 *
 * @package WordPress
            	...
            	<div class="row" style="margin-bottom: 50px;">
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-left">
                    ...
                    <div class="con_left2_midd page_thumb">
                      <?php if(get_field('featured_img1') != ''):?>
                          <img src="<?php the_field('featured_img1'); ?>" alt="Loungewear" />
                      <?php else: ?>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-left">
                    ...
                    <div class="con_left2_top"><img src="<?php bloginfo('template_url'); ?>/images/img_top_bg2.png" alt="" /></div>
                    <div class="con_left2_midd page_thumb">
                      <?php if(get_field('featured_img2') != ''):?>
                          <img src="<?php the_field('featured_img2'); ?>" alt="Loungewear" />
                      <?php else: ?>
                          <img src="/images/bedding/bellanotte/top-left-corner.jpg" alt="Bella Notte Linens" />
                      <?php endif; ?>
                    </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-left">
                    ...
                    <div class="con_left2_top"><img src="<?php bloginfo('template_url'); ?>/images/img_top_bg2.png" alt="" /></div>
                    <div class="con_left2_midd page_thumb">
                      <?php if(get_field('featured_img3') != ''):?>
                          <img src="<?php the_field('featured_img3'); ?>" alt="Loungewear" />
                      <?php else: ?>
                          <img src="/images/bedding/bellanotte/top-left-corner.jpg" alt="Bella Notte Linens" />
                      <?php endif; ?>
                    </div>
