...
<?php endif; ?>
  ...
  <div id="footer">
  <div class="container">
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 pull-left">We Ship Anywhere in Canada | <a href="<?php echo get_the_permalink('1424'); ?>">Shipping &amp; Returns</a><br />Copyright &copy; <?php echo date('Y'); ?> shadesofsleep.com. All Rights Reserved. <br /><a href="https://www.oracast.com" target="_blank">Website by Oracast</a></div>
